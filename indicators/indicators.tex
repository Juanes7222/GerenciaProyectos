...
\begin{table}[H]
    \centering
    \includegraphics[width=\linewidth]{indicators/images/tabla_final1.png}
    \caption{Matriz de indicadores mes 1 - 12}
    \vspace{0.2cm}
...
\begin{table}[H]
    \centering
    \includegraphics[width=\linewidth]{indicators/images/tabla_final2.png}
    \caption{Matriz de indicadores mes 13 - 24}
     \vspace{0.2cm}
    \small Fuente: Elaboración propia
