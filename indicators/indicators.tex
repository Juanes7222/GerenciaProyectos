...
En el contexto colombiano, el DANE reportó que el PIB de Pereira alcanzó aproximadamente 28 billones de pesos en 2023 (DANE, 2024). Considerando esta base y los rangos de crecimiento derivados de la literatura mencionada, se estima que la implementación del sistema digital podría generar un impacto positivo progresivo sobre el PIB local equivalente a un aumento del 0.005\% en un año.